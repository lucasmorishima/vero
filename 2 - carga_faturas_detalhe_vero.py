...
""")
print(f"DDL {TBL_DESTINO} OK — 24 colunas (schema v3)")
...
# MAGIC %md
# MAGIC ## 5. Mapeamento 1:1 — 24 colunas (schema v3)
# MAGIC
...
df_result = (
    ...
    .select(
        ...
        # 29. FAIXA — transcrito diretamente de accenture.validacao_status_fatura
