...
# MAGIC %md
# MAGIC # MIGRATION — accenture.detalhes_da_fatura_vero — Schema v2
# MAGIC
# MAGIC **Alteracoes:**
...
# MAGIC
# MAGIC **Schema resultante: 22 colunas (era 28)**
# MAGIC
# MAGIC > ⚠️ Executar UMA UNICA VEZ. Verificar backup antes se necessario.

# COMMAND ----------

TBL = "accenture.detalhes_da_fatura_vero"
...
ok = schema_final == esperado
print(f"\nSchema correto: {'✅' if ok else '❌ — verificar diferenca acima'}")
if not ok:
